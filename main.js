const detours = [
  {
    ...
    image: '/detours/yellow-trail.webp', imageAlt: 'A yellow bicycle, flowers, umbrella, and doorway form a trail through a quiet street.',
  },
  {
    ...
    image: '/detours/quiet-table.webp', imageAlt: 'A quiet café table with a warm drink, an unfamiliar pastry, a blunt pencil, and a blank notebook.',
  },
  {
    ...
    image: '/detours/tiny-wonders.webp', imageAlt: 'Five tiny found objects resting on a sunlit stone ledge.',
  },
  {
    ...
    image: '/detours/borrowed-song.webp', imageAlt: 'Two people exchange a pair of wired headphones beside a waiting train.',
  },
  {
    ...
    image: '/detours/future-memory.webp', imageAlt: 'A person sits with a drink in a sunlit glasshouse, looking out through the plants.',
  },
  {
    ...
    image: '/detours/coin-route.webp', imageAlt: 'A hand flips a coin where two old city streets split left and right.',
  },
];
